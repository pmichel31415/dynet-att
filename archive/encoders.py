...
class EmptyEncoder(Encoder):
    """Empty encoder (does nothing) to be used with unconditional decoder to make a LM"""
...
class LSTMEncoder(Encoder):
    """Standard unidirectional lstm encoder"""
...
class BiLSTMEncoder(LSTMEncoder):
    ...
    def __init__(self, nl, di, dh, vs, pc, dr=0.0, pre_embs=None):
        ...
        self.dim += dh
        # Backward encoder
        self.rev_lstm = dy.VanillaLSTMBuilder(
            self.nl, self.di, self.dh, self.pc)
